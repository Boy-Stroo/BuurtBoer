...
public class UserService : HTTPService
{
    ...
    public async Task<int> getLunchesCountlastMonth(Guid EmployeeID)// functie om het aantal lunches van afgelopen maand te pakken voor ��n employee.
    {
    ...
    public async Task<int> getLunchesCountNextWeek(Guid EmployeeID)// functie om het aantal lunches voor de komende week te pakken voor ��n employee.
    {
