...
namespace Web_App
{
    public class UserController
    {
        ...
        public async Task<int> getLunchesAmountLastMonth(Guid employeeID)// Totaal aantal lunches voor ��n employee in de afgelopen maand.
        {
            var count = await _userService.getLunchesCountlastMonth(employeeID);
            return count;
        }

        public async Task<int> getLunchesAmountNextWeek(Guid employeeID)// Totaal aantal lunches voor ��n employee in de aankomende week.
        {
